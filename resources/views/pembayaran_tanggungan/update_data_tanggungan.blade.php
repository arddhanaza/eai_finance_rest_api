                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">Update Data Tanggungan</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Update Data Tanggungan</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('save_update_data_tanggungan',$data_tanggungan->id_tanggungan)}}" method="put">
                            @csrf
                            @method('put')
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status_tanggungan" id="status_tanggungan" class="form-control">
                                                <option value="{{$data_tanggungan->status_tanggungan}}" selected>{{$data_tanggungan->status_tanggungan}}</option>
