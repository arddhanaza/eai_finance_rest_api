                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a disabled href="#">Edit Data Asset</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('save_edit_data_asset',$data_asset->id_asset)}}" method="put">
                            @csrf
                            @method("put")
                            <h6 class="heading-small text-muted mb-4">Edit Data Asset</h6>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_asset"
                                                   id="nama_asset" required value="{{$data_asset->nama_asset}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="valuasi_asset"
                                                   id="valuasi_asset" required value="{{$data_asset->valuasi_asset}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tanggal_aktif"
                                                   id="tanggal_aktif" required value="{{$data_asset->tanggal_aktif}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jenis_asset"
                                                   id="jenis_asset" required value="{{$data_asset->jenis_asset}}"placeholder="Alat Tulis, Bangunan, Operasional">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="id_divisi"
                                                ...
                                                @foreach($data_divisi as $divisi)
                                                    @if($data_asset->id_divisi == $divisi->id_divisi)
                                                        <option
                                                            value="{{$divisi->id_divisi}}" selected>{{$divisi->nama_divisi}}</option>
                                                    @else
                                                    <option
